...
/**
 * 设计UI样式，以达到改变窗体样式的效果，在ServerFrame类的tpServer.setUI(new CustomTabbedPaneUI());语句调用
 * 因效果不佳、最终没有应用---ServerFrame.java中第49行
 */
public class CustomTabbedPaneUI extends BasicTabbedPaneUI {
    private static final Color SELECTED_TAB_COLOR = new Color(10, 138, 175);
